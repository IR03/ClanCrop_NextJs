...
const MainPage = () => {
    ...
    const getSearchData = (e) => {
        e.preventDefault();
        setSearchFilter(searchData.current.value);
    }
    ...
    return (
        ...
        <>
                                ...
                                <div className="table_content sesction_pt">

                                    {
                                        (finalData?.length) ?
                                            ...
                                            :
                                            <div className='bg-danger w-100 p-4 text-center rounded-2 cl_white fs20 bold'>
                                                Table Data is not available for this Search Keyword
                                            </div>
            ...
            {
                (!isLoading && error) &&
                <Container className='d-flex justify-content-center align-items-center cl_pm'>
                    data not found
                </Container>
            }
        </>
